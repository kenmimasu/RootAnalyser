...
histargs = (
            ('hist1','Histogram I',21,-10.,10.),
            ('hist2','Histogram II',50,0.,500.),
...
class MyPySelector( TPySelector ):
    ...
    def Process( self, entry ):
        ...
        # Filling a histogram:
        if evt.njet >=2: # at least 2 jets in event
            ...
            self.histos['hist1'].Fill(jet1.eta*jet2.eta) 
            # jet invariant mass
            mjj = Minv(jet1, jet2) 
            self.histos['hist2'].Fill(mjj)
            self.histos['hist3'].Fill(abs(jet1.eta-jet2.eta)) 
